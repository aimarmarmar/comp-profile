<footer class="px-10 w-full h-auto bg-customPink static bottom-0 text-center text-gray-50 p-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        <aside class="flex flex-col items-center">
            ...
            <div class="flex space-x-4 mt-4">
                <!-- Facebook -->
                <a href="https://facebook.com" target="_blank" aria-label="Facebook" class="hover:text-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="text-white" x="0px" y="0px"
                ...
                <!-- Twitter -->
                <a href="https://twitter.com" target="_blank" aria-label="Twitter" class="hover:text-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="text-white" x="0px" y="0px"
                        width="30" height="30" viewBox="0 0 48 48">
                        <path
                ...
                <!-- Instagram -->
                <a href="https://instagram.com/dmiehan/" target="_blank" aria-label="Instagram"
        ...
        <nav>
            <h6 class="footer-title text-white text-sm mb-1">Services</h6>
            <ul class="space-y-0.5">
                <li><a class="link link-hover text-white text-sm">Kemitraan</a></li>
                <li><a class="link link-hover text-white text-sm">Alamat</a></li>
                <li><a class="link link-hover text-white text-sm">Dukungan</a></li>
            </ul>
        </nav>
        <nav>
            <h6 class="footer-title text-white text-sm mb-1">Company</h6>
            <ul class="space-y-0.5">
                <li><a class="link link-hover text-white text-sm">About us</a></li>
                <li><a class="link link-hover text-white text-sm">Contact</a></li>
                <li><a class="link link-hover text-white text-sm">Careers</a></li>
            </ul>
        </nav>
        <nav>
            <h6 class="footer-title text-sm mb-1">Legal</h6>
            <ul class="space-y-0.5">
                <li><a class="link link-hover text-sm">Terms of use</a></li>
                <li><a class="link link-hover text-sm">Privacy policy</a></li>
                <li><a class="link link-hover text-sm">Cookie policy</a></li>
            </ul>
        </nav>
    </div>
</footer>
